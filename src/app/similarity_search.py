...
def extract_system_context(system_state):
    ...
    return {
        ...
        "ai_decision_confidence": system_state.get("ai_decision_confidence", "medium"),
        "system_performance": system_state.get("system_performance", 0),
        "risk_perception": system_state.get("risk_perception", "neutral"),
        "stress": system_state.get("stress", "medium"),
        "trust": system_state.get("trust", "medium"),
        "cognitive_load": system_state.get("cognitive_load", "medium"),
    }
