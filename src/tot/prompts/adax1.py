...
- If the AI has moved (changes in AI position/coordinates) without holding anything, your answer MUST be:
...
Movements of AI player: position or where AI player is at are different in **Recent/Previous User State** and **Current Task Summary**.
